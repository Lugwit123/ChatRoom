...
class ChatClient:
    def __init__(self, username: str, password: str):
        ...
        :param password: 登录密码。
        """
        self.server_url = 'http://192.168.112.73:1026'
        self.login_url = 'http://192.168.112.73:1026/api/auth/login'
...
def send_message(recipient:str,jsonFilePath:str):
        ...
        url=f"http://192.168.112.73:1026/check_file/abc_check_show/{jsonFilePath}"
